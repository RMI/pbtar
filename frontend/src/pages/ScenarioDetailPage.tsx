  ...
  if (!scenario) {
    return (
      <div className="container mx-auto px-4 py-8 text-center">
        <h2 className="text-2xl font-bold text-gray-800 mb-4">Scenario Not Found</h2>
        <p className="text-gray-600 mb-6">The scenario you're looking for doesn't exist or has been removed.</p>
        <Link 
          to="/"
        ...
        <div className="bg-gradient-to-r from-teal-700 to-blue-800 p-6 text-white">
          ...
          <div className="flex flex-col sm:flex-row sm:justify-between text-sm">
            <p className="mb-1 sm:mb-0">
              <span className="text-teal-200">Publisher:</span> {scenario.publisher}
            </p>
            <p>
              <span className="text-teal-200">Published:</span> {scenario.publishedDate}
            </p>
          </div>
        </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-12 gap-6">
            <div className="md:col-span-8">
              <section className="mb-8">
                <h2 className="text-xl font-semibold text-gray-800 mb-3">Scenario Overview</h2>
              ...
              <section className="mb-8">
                <h2 className="text-xl font-semibold text-gray-800 mb-3">Expert Recommendations</h2>
                <div className="prose text-gray-700">
              ...
              <section>
                <h2 className="text-xl font-semibold text-gray-800 mb-3">Data Source</h2>
                <div className="bg-gray-50 border border-gray-200 rounded-lg p-4">
                  <p className="text-gray-700 mb-4">{scenario.dataSource.description}</p>
            ...
            <div className="md:col-span-4">
              ...
              <div className="bg-gray-50 border border-gray-200 rounded-lg p-4">
                <h3 className="text-lg font-medium text-gray-800 mb-3">Sectors</h3>
                <div className="flex flex-wrap">
