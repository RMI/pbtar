    ...
    return (
      <div className="bg-gray-50 p-4">
        <div className="max-w-6xl mx-auto">
          <div className="rounded-lg bg-white border border-neutral-200/70 p-4 shadow-sm flex items-center justify-between">
            <div className="w-12" />

            <h2 className="text-lg font-semibold text-bluespruce text-center mx-auto">
  ...
  return (
    <div className="bg-gray-50 p-6">
      <div className="max-w-6xl mx-auto">
        ...
        <div className="rounded-lg bg-white border border-neutral-200/70 p-6 shadow-sm">
                ...
                <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-6 gap-6">
                  {steps.map((step, index) => {
                    return (
                      ...
                      >
                        <div
                          className="flex items-center justify-center h-9 w-9 rounded-full bg-neutral-100 text-rmiblue-800 border border-rmiblue-800 group-hover:bg-rmiblue-200 group-focus:bg-rmiblue-200 transition-colors"
                          aria-hidden="true"
                        >
        ...
        {/* small spacer so the panel breathes on wide layouts */}
        <div className="h-4" />
      </div>
    </div>
  );
