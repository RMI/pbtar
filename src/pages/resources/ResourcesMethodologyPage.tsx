...
const CollapsibleSubsection: React.FC<{
  ...
  const containerClassName =
    className ?? (inBox ? "px-6 py-4" : "mt-10 max-w-5xl");
  const buttonClassName = inBox
    ? "w-full grid grid-cols-[1fr_auto] items-start gap-4 text-left group"
    : "w-full flex items-center justify-between gap-4 py-2 text-left group";
  ...
  return (
    <div className={containerClassName}>
      ...
      {isOpen && (
        <div
          id={contentId}
          className={inBox ? "mt-4 text-rmigray-700" : "mt-4"}
        >
          {children}
        </div>
      )}
    ...
    <div className="container mx-auto px-4 py-10">
      ...
      <div className="mt-10">
        ...
        <p className="text-rmigray-700 max-w-5xl">
          ...
          assumptions. These are useful to understand the idea behind a pathway
          or scenario and the broad implications of the modelled changes.
        </p>
        ...
        <div className="mt-6 max-w-5xl rounded-lg bg-white shadow overflow-hidden">
          <div className="divide-y divide-neutral-200/70">
            ...
            >
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6 text-rmigray-700">
                <div>
                  ...
                  <p className="mt-2">
                    Predictive pathways begin with assumptions considered
                    probable by the developer and project likely future
                    outcomes.
                  </p>
                  <p className="mt-3">
                ...
                <div>
                  ...
                  <p className="mt-2">
                    ...
                    climate outcome such as 1.5°C, and work backward to produce
                    a pathway consistent with that goal.
                  </p>
                  <p className="mt-3">
            ...
            >
              <div className="text-rmigray-700">
                <p>
                  Where available, temperature outcome acts as a proxy for
                  pathway ambition. It refers to the °C global heating above
                  pre-industrial levels by the end of the century, disregarding
                  potentially higher peak increases before that.
                </p>
                <p className="mt-3">
                  Global pathways often provide a temperature outcome as they
                  can be linked to a carbon budget. Regional or sector-specific
                  pathways usually do not have a clear temperature outcome
                  because a global model is required to calculate it.
                </p>
              </div>
            </CollapsibleSubsection>
            ...
            >
              <div className="text-rmigray-700">
                <p>
                  ...
                  forward-looking modelling. It is the final year of the
            ...
            >
              <div className="text-rmigray-700">
                ...
                <p className="mt-3">
                  For example, if the pathway metrics are available until 2050,
                  but there is a temperature outcome for 2100, then the end year
                  is 2050.
                </p>
              </div>
            </CollapsibleSubsection>
            ...
            >
              <div className="text-rmigray-700">
                <p>
                  The year in which the pathway reaches net zero emissions. Not
                  all pathways reach net zero emissions, so this value will not
                  always be provided.
                </p>
                <p className="mt-3">
        ...
        <div className="mt-6 max-w-5xl rounded-lg bg-white shadow overflow-hidden">
          <div className="divide-y divide-neutral-200/70">
            ...
            >
              <div className="text-rmigray-700">
                <p>
                  ...
                  benchmark metrics for. All individual countries are allowed,
                  based on ISO2 (3166) definitions. Regions are provided as
                  defined in the pathway.
                </p>
                <p className="mt-3">
            ...
            >
              <div className="text-rmigray-700">
                <p>
                  List of economic sectors that the pathway covers, where
                  coverage means that the pathway provides at least one relevant
                  output metric for each of the sectors assigned here.
                </p>
                <p className="mt-3">
                  NOTE: The repository is currently limited to providing
                  detailed information on the power sector. Additional sectors
                  will be added in the near future. This variable also clarifies
                  which other sectors a pathway models.
                </p>
            ...
            >
              <div className="text-rmigray-700">
                <p>
                  List of segments of sectors that the pathway covers. Segments
                  are the main individual parts of the sector's value chain
                  and/or market segments. The sector segments listed for a
                  pathway are the segments are the segments used in modelling
                  the pathway results. Sector specific metrics additionally
                  clarify the segments they cover, which may be a subset of the
                  sector segments used in the model.
                </p>
                <p className="mt-3">
                  For example, a pathway may describe which input fuels are used
                  in the power sector and as such it covers “Upstream input
                  fuels and materials”. However, for the “Emissions intensity”
                  benchmark metric, it will only cover the “Power generation
                  (on-grid)" segment of the sector.
                </p>
                <p className="mt-3">
                  Sector segments are only defined for the sectors that are
                  covered in detail, and the allowed values are listed below.
                </p>
                <ul className="mt-3 list-disc pl-5 space-y-1">
                  <li>
                    Power: Upstream input fuels and materials, Power generation
                    (on-grid), Captive power generation (behind-the-meter),
                    Power storage, Power grid (transmission and distribution,
                    grid connection).
                  </li>
                  {/* <li>
            ...
            >
              <div className="text-rmigray-700">
                <p>
                  This field shows the technologies that a pathway provides
                  output for within the sector(s) that it covers. It is returned
                  for any sector that is identified as in-scope in the “sectors”
                  variable and that has specified allowed values here. As the
                  sector coverage of the TPR expands, sectors which we show
            ...
            >
              <div className="text-rmigray-700">
                <p>
                  List of sector-specific benchmark metrics that the pathway
                  reports outcomes for. Currently, this is only defined for the
                  power sector, but it will be expanded to each additional
                  sector that we fully cover in the repository.
                </p>
                <ul className="mt-3 list-disc pl-5 space-y-1">
                  <li>
            ...
            >
              <div className="text-rmigray-700">
                ...
                <p className="mt-3">
                  ...
                  benchmark data is supposed to be compared to (e.g. the
                  emissions reported by a company), the analyst may have to
                  consider making additional calculations or assumptions to be
                  able to use the pathway, or use another pathway with matching
                  the emissions scope.
                </p>
                <p className="mt-3">
                  NOTE: this does not directly translate to emission scopes 1,2,
                  and 3. Such scopes refer to the segments of the value chain
                  that are covered by the emissions accounting of a company. To
                  check which segments of a sector are covered by the emissions
                  data of a pathway, refer to the “sector segments” values that
                  are shown in the corresponding benchmark data.
                </p>
                <p className="mt-3">The list of allowed values is:</p>
                <ul className="mt-3 list-disc pl-5 space-y-1">
                  <li>CO2,</li>
            ...
            >
              <div className="text-rmigray-700">
                <p>
                  Lists which types of policies the pathway models. Refers only
                  to the instruments, not their ambitiousness.
                </p>
                <p className="mt-3">
            ...
            >
              <div className="text-rmigray-700">
                <p>
                  A list of the main new technologies covered by the pathway
                  that are not scaling yet, but that will play a role in the
                  future. The included technologies do not necessarily come with
                  a detailed timeseries.
                </p>
                <p className="mt-3">
                  Analysts can use this as a proxy for how optimistic the
                  pathway is regarding technological breakthroughs. This can be
                  useful both as a first steps in technology risk analysis as
                  well as in opportunity identification.
                </p>
                <p className="mt-3">The list of allowed values is:</p>
                <ul className="mt-3 list-disc pl-5 space-y-1">
            ...
            >
              <div className="text-rmigray-700">
                ...
                <p className="mt-3">
                  ...
                  future profitability and competitiveness is to be analyzed,
                  especially in technologies whose costs are projected to
                  decrease over time.
                </p>
                <p className="mt-3">The list of allowed values is:</p>
                <ul className="mt-3 list-disc pl-5 space-y-1">
            ...
            >
              <div className="text-rmigray-700">
                <p>
                  Describes the availability and granularity of the investment
                  needs data provided by the pathway.
                </p>
                <p className="mt-3">
                  This can be an indication if the investment pipeline of a
                  company is on pace with assumed requirements of the pathway.
                  Where more detail is provided, it can also highlight, what
                  part of the value chain needs most investment and if that is
                  reflected in a company’s strategy.
                </p>
                <p>
                  Note: It is usually not possible to fully derive investment
                  requirements based on unit costs and capacity growth numbers
                  by sector and technology. This is because capacity numbers do
                  not show how much investment goes into maintenance and
      ...
      <div className="mt-10">
        ...
        <p className="text-rmigray-700 max-w-5xl">
          Each pathway describes trends that are built on assumptions of how the
          future will unfold. These, together, paint a relatively full picture
          of the pathway narrative. Different types of corporate transition
          assessment use cases usually work with different types of narratives,
          which is why it is crucial to have a good grasp of the pathways
          assumptions and trends when selecting pathways for an analysis.
        </p>
        ...
        <div className="mt-6 max-w-5xl rounded-lg bg-white shadow overflow-hidden">
          <div className="divide-y divide-neutral-200/70">
            ...
            >
              <div className="text-rmigray-700">
                <p>
                  Summarizes how GHG emissions develop in the pathway between
                  the start year of the model and the end year of the model.
                </p>
                <p className="mt-3">
            ...
            >
              <div className="text-rmigray-700">
                <p>
                  Summarizes how energy efficiency, defined as energy use per
                  USD GDP output, develops in the pathway between the start year
                  of the model and the end year of the model.
                </p>
                <p className="mt-3">
                  The underlying calculation is made using the compound annual
                  growth rate.
            ...
            >
              <div className="text-rmigray-700">
                <p>
                  Summarizes how energy demand develops in the pathway between
                  the start year of the model and the end year of the model.
                </p>
                <p className="mt-3">
                  The underlying calculation is made using the compound annual
            ...
            >
              <div className="text-rmigray-700">
                <p>
                  Summarizes how the share of electricity in energy end use
                  develops in the pathway between the start year of the model
                  and the end year of the model.
                </p>
                <p className="mt-3">
                  The underlying calculation is made using the compound annual
                  growth rate.
            ...
            >
              <div className="text-rmigray-700">
                <p>
                  Describes the level of ambition of the policies modelled in
                  the pathway. This is a key differentiator for many pathways
                  and higher policy ambition is often considered to be harder to
                  achieve.
                </p>
                <p className="mt-3">
                  From a risk angle, ambition closer to “current/legislated” is
                  more likely to occur, but not the only plausible future
                  outcome. Higher ambition pathways often come with remaining
                  implementation gaps, which means they can be a good basis to
                  understand bottlenecks for the transition of a sector. These,
                  in turn, can be opportunities in some cases, or indicators
                  where policymakers could intervene.
                </p>
                <p className="mt-3">The list of allowed values is:</p>
                <ul className="mt-3 list-disc pl-5 space-y-1">
            ...
            >
              <div className="text-rmigray-700">
                <p>
                  ...
                  technologies of in-scope sectors. This shows if newer
                  low-carbon technologies become more competitive compared to
                  their high-carbon counterparts.
                </p>
                <p className="mt-3">
                  Analysts may be interested in how fast costs of individual
                  technologies are assumed to change. Technology costs play a
                  key role in determining if a company moves too fast or too
                  slow to capture the benefits of sectoral change.
                </p>
                <p className="mt-3">The list of allowed values is:</p>
                <ul className="mt-3 list-disc pl-5 space-y-1">
                  <li>Increase,</li>
