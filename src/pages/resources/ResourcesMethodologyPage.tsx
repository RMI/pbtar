...
const CollapsibleSubsection: React.FC<{
  ...
  inBox?: boolean;
  className?: string;
}> = ({ title, subtitle = "placeholder", children, inBox = false, className }) => {
  ...
  return (
    <div className="container mx-auto px-4 py-10">
            ...
            >
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6 text-rmigray-700">
                ...
                <div>
                  ...
                  <p className="mt-3">
                    These are often useful for ambition and alignment
                    questions.
                  </p>
                </div>
              </div>
            ...
            >
              <div className="text-rmigray-700">
                <p>
                  ...
                  any forward-looking modelling. It is the final year of the
            ...
            >
              <div className="text-rmigray-700">
                ...
                <p className="mt-3">
                  ...
                  but there is a temperature outcome for 2100, then the end
                  year is 2050.
                </p>
              </div>
            </CollapsibleSubsection>
      ...
      <div className="mt-10">
        ...
        <div className="mt-6 max-w-5xl rounded-lg bg-white shadow overflow-hidden">
          <div className="divide-y divide-neutral-200/70">
            <CollapsibleSubsection title="Regions" inBox>
              <div className="text-rmigray-700">
                <p>
            ...
            <CollapsibleSubsection title="Sectors" inBox>
              <div className="text-rmigray-700">
                <p>
            ...
            <CollapsibleSubsection title="Sector segments" inBox>
              <div className="text-rmigray-700">
                <p>
            ...
            <CollapsibleSubsection title="Technologies" inBox>
              <div className="text-rmigray-700">
                <p>
            ...
            <CollapsibleSubsection title="Metrics" inBox>
              <div className="text-rmigray-700">
                <p>
            ...
            <CollapsibleSubsection title="Emissions scope" inBox>
              <div className="text-rmigray-700">
                <p>
            ...
            <CollapsibleSubsection title="Policy types" inBox>
              <div className="text-rmigray-700">
                <p>
            ...
            <CollapsibleSubsection title="New technologies included" inBox>
              <div className="text-rmigray-700">
                <p>
            ...
            <CollapsibleSubsection title="Technology costs detail" inBox>
              <div className="text-rmigray-700">
                <p>
            ...
            <CollapsibleSubsection title="Investment needs" inBox>
              <div className="text-rmigray-700">
                <p>
      ...
      <div className="mt-10">
        ...
        <div className="mt-6 max-w-5xl rounded-lg bg-white shadow overflow-hidden">
          <div className="divide-y divide-neutral-200/70">
            <CollapsibleSubsection title="Emissions trajectory" inBox>
              <div className="text-rmigray-700">
                <p>
            ...
            <CollapsibleSubsection title="Energy efficiency" inBox>
              <div className="text-rmigray-700">
                <p>
            ...
            <CollapsibleSubsection title="Energy demand" inBox>
              <div className="text-rmigray-700">
                <p>
            ...
            <CollapsibleSubsection title="Electrification" inBox>
              <div className="text-rmigray-700">
                <p>
            ...
            <CollapsibleSubsection title="Policy ambition" inBox>
              <div className="text-rmigray-700">
                <p>
            ...
            <CollapsibleSubsection title="Technology cost trend" inBox>
              <div className="text-rmigray-700">
                <p>
