...
import pathwayTimeseries from "../src/schema/pathwayTimeseries.json" with { type: "json" };
...
async function run(dir: string) {
  ...
  const { valid, invalid } = validateFilesBySchema(entries, [pathwayMetadata, pathwayTimeseries]);
